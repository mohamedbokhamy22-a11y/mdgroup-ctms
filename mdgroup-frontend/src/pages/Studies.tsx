      ...
      <div className="p-5">
        ...
        <div className="flex items-start justify-between gap-3 mb-3">
          <div className="flex-1 min-w-0">
            <p className="text-[11px] font-mono text-gray-400 mb-1">{study.protocolNumber ?? '—'}</p>
        ...
        {(study.startDate || study.indication) && (
          <div className="flex items-center gap-3 mt-4 pt-4" style={{ borderTop: '1px solid var(--color-border)' }}>
            ...
            {study.indication && (
              <p className="text-[11px] text-gray-400 truncate">{study.indication}</p>
            )}
          </div>
        )}
      </div>
  ...
  return (
    <div className="p-6 space-y-5" style={{ background: 'var(--color-background)' }}>
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-[18px] font-bold text-gray-900">Studies</h2>
          <p className="text-[13px] text-gray-500 mt-0.5">Clinical trial protocol management</p>
        </div>
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-gray-400">
          ...
          <p className="text-[14px] font-medium">No studies match your filters</p>
        </div>
      ) : (
